                        ...
                        <tbody>
                            ...
                            <c:forEach
                                ...
                                <c:if test="${empty param.searchId
                                              or c.id.trim().equalsIgnoreCase(param.searchId.trim())}">
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <c:out value="${c.nationality.name}" />
                                          </td>

                                          <td class="text-center">

                                              <a
                                                  href="${pageContext.request.contextPath}/customer?action=viewDetail&id=${c.id}"
                                              ...
                                              <a
                                                  href="${pageContext.request.contextPath}/customer?action=update&id=${c.id}"
