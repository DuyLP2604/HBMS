    ...
    <div class="container my-5">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-header employee-header text-white d-flex justify-content-between align-items-center py-3">
                ...
                <a
                    href="${pageContext.request.contextPath}/employee?action=add"
                    ...
                    <div class="col-md-6">
                        ...
                        <form
                            ...
                            <div class="input-group">
                                ...
                                <button
                                    type="submit"
                                    class="btn employee-btn text-white"
                                    >
                                    Search
                                </button>
                        ...
                        <tbody>
                            ...
                            <c:forEach
                                ...
                                <c:if test="${empty param.searchId
                                              or e.id.trim().equalsIgnoreCase(param.searchId.trim())}">
                                      ...
                                      <tr>
                                          ...
                                          <td class="text-center">
                                              ...
                                              <a
                                                  href="${pageContext.request.contextPath}/employee?action=viewDetail&id=${e.id}"
                                              ...
                                              <a
                                                  href="${pageContext.request.contextPath}/employee?action=update&id=${e.id}"
