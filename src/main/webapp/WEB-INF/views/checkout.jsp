    ...
    <div class="container-fluid px-4 py-4">
        ...
        <div class="row g-4">
                                            ...
                                            <c:forEach
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a
                                                            href="${pageContext.request.contextPath}/invoice?bookingId=${room.bookingId}"
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex gap-2 align-items-center bg-light p-3 rounded border border-secondary border-opacity-25 mb-3">
                            ...
                            <input
                                type="number"
                                id="itemQty"
                                class="form-control text-center service-qty-input"
                                value="1"
                                min="1"
                                placeholder="Qty"
                                >
                            ...
                            <button
                                type="button"
                                class="btn btn-success text-nowrap px-3"
                        ...
                        <div class="table-responsive border rounded">
                            ...
                            <table
                                class="table table-custom text-center align-middle mb-0"
                                id="servicesTable"
                                >
                                ...
                                <tbody id="servicesBody">
                                    ...
                                    <c:forEach
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                class="item-total text-danger fw-bold format-money"
                                                data-value="${srv.unitPrice}"
                                                >
                                                <c:out value="${srv.unitPrice}" />
                                            </td>
                ...
                <!-- Payment -->
                <form
                    action="${pageContext.request.contextPath}/invoice"
                    method="post"
                    >
                                ...
                                <c:when test="${not empty selectedRoom}">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <a
                                                href="${pageContext.request.contextPath}/invoice?action=print&bookingId=${selectedRoom.bookingId}"
                                                target="_blank"
